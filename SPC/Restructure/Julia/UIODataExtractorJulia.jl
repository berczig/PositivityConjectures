...
# Python calls
using PyCall
@pyimport SPC.Restructure.cores.CorrectSequenceCoreGenerator
@pyimport SPC.Restructure.cores.CorrectSequenceCoreGeneratorAbstract
@pyimport SPC.Restructure.cores.EscherCoreGeneratorBasic
@pyimport SPC.Restructure.cores.EscherCoreGeneratorTripple
@pyimport SPC.Restructure.cores.EscherCoreGeneratorAbstract
...
end # module SPC.Restructure.Julia