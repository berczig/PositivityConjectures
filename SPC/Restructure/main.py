...
if __name__ == "__main__":
    ...
    core_generator_type =  "EscherCoreGeneratorQuadruple" #"EscherCoreGeneratorTrippleSymmetricNoEqual" # "EscherCoreGeneratorBasic"   "EscherCoreGeneratorTripple" "EscherCoreGeneratorTrippleSymmetricNoEqual"
    iteration_steps = 500
    RL_n_graphs = 200
    condition_rows = 4
