...
class EscherCoreGeneratorQuadruple(EscherCoreGeneratorAbstract):
    ...
    def getCoreComparisions(partition):
        ...
        # Simplified comparison set, based on triple pair experiments and mathematical analysis
        # return {
        #     "0" : ["subescher uv start", "subescher uw start", "subescher vw start", "subescher uv_w start", "subescher uw_v start", "subescher vw_u start", 
        #            "subescher uz start", "subescher vz start", "subescher wz start", 
        #            "subescher uv_w start", "subescher uw_v start", "subescher vw_u start",
        ...
        #     "subescher wz end" : ["uv 1. insert","uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher uv_w end" : ["uv_w 1. insert"],#, "uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uw_v end" : ["uw_v 1. insert"],# "uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vw_u end" : ["vw_u 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uv_z end" : ["uv_z 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uz_v end" : ["uz_v 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vz_u end" : ["vz_u 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uw_z end" : ["uw_z 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uz_w end" : ["uz_w 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher wz_u end" : ["wz_u 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vw_z end" : ["vw_z 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vz_w end" : ["vz_w 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher wz_v end" : ["wz_v 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uvw_z end" : ["uvw_z 1. insert"],# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uvz_w end" : ["uvz_w 1. insert"],# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uwz_v end" : ["uwz_v 1. insert"],# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vwz_u end" : ["vwz_u 1. insert"],# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uv_wz end" : ["uv_wz 1. insert"],# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uw_vz end" : ["uw_vz 1. insert"],# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vw_uz end" : ["vw_uz 1. insert"]}# "uvz_w 1. insert", "uwz_v 1. insert", "vwz_u 1. insert", "uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],}
        # return {
        #     "0" : ["subescher uv start", "subescher uw start", "subescher vw start", "subescher uv_w start", "subescher uw_v start", "subescher vw_u start", 
        #            "subescher uz start", "subescher vz start", "subescher wz start", 
        #            "subescher uv_w start", "subescher uw_v start", "subescher vw_u start",
        ...
        #             "subescher uv_wz start", "subescher uw_vz start", "subescher vw_uz start"],
        #     "subescher uv end" : ["uv 1. insert"],#"uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher uw end" : ["uw 1. insert"],#"uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher vw end" : ["vw 1. insert"],#"uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher uz end" : ["uz 1. insert"],#"uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher vz end" : ["vz 1. insert"],#"uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher wz end" : ["wz 1. insert"],#"uw 1. insert","vw 1. insert", "uz 1. insert", "vz 1. insert", "wz 1. insert"],
        #     "subescher uv_w end" : ["uv_w 1. insert"],#, "uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uw_v end" : ["uw_v 1. insert"],# "uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher vw_u end" : ["vw_u 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
        #     "subescher uv_z end" : ["uv_z 1. insert"], #"uw_v 1. insert", "vw_u 1. insert", "uv_z 1. insert", "uz_v 1. insert", "vz_u 1. insert","uw_z 1. insert", "uz_w 1. insert", "wz_u 1. insert", "vw_z 1. insert", "vz_w 1. insert", "wz_v 1. insert","uv_wz 1. insert", "uw_vz 1. insert", "vw_uz 1. insert"],
