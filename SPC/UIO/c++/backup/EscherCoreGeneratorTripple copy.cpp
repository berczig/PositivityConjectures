...
vector<char> EscherCoreGeneratorTripple::generateCore(const string& escher) {
    ...
    vector<char> core_u_v = get_shortb_insertion_and_subescher_of_2_eschers(u,v);
    vector<char> core_v_w = get_shortb_insertion_and_subescher_of_2_eschers(v,w);
    vector<char> core_u_w = get_shortb_insertion_and_subescher_of_2_eschers(u,w);
    vector<char> core_uw_v;
    vector<char> core_vw_u;
    vector<char> core_uv_w;
